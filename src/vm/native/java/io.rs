...
/// File operations live with java.io, even though their implementation uses
/// the Android sandbox checker shared by the framework shims.
#[cfg(feature = "android")]
pub(crate) const FILE_TABLE: &[NativeEntry] = &[
    ne!(
        "Ljava/io/File;",
        "<init>",
        "(Ljava/lang/String;)V",
